...
public class Product {
    ...
    public Product(String productName, Integer price, Float weight, Integer quantity, String description, User user) {
        this.productName = productName;
        this.price = price;
        this.weight = weight;
        this.quantity = quantity;
    ...
    public boolean saveProduct() {
        ...
        try {
            ...
            String query = "insert into products (product_name,price,weight,quantity,description,user_id) value (?,?,?,?,?,?)";
